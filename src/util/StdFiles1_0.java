...
import main.FTP;
import main.MainProgram1_2;

/**
 * This class contains all the functions used by the main program of TAGOPSIN (MainProgram1_2.java) to 
...
public class StdFiles1_0 {
	...
	public static void downloadGO(String dir) throws IOException {
		...
		MainProgram1_2.wgetFile(url,"go-basic.obo",dir+"/gene_ontology");	
	...
	public static void downloadPDB(String dir) throws IOException {
		...
		MainProgram1_2.wgetFile(url,"entries.idx",dir+"/pdb");
		
		url = new URL("http://ftp.wwpdb.org/pub/pdb/derived_data/pdb_seqres.txt.gz");
		
		MainProgram1_2.wgetFile(url,"pdb_seqres.txt.gz",dir+"/pdb");
